...
synth_design -top Prj_ClockStopWatch -part xc7a35tcpg236-1
...
write_checkpoint -force -noxdef Prj_ClockStopWatch.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
create_report "synth_1_synth_report_utilization_0" "report_utilization -file Prj_ClockStopWatch_utilization_synth.rpt -pb Prj_ClockStopWatch_utilization_synth.pb"
